...
1. The Go SDK tag `sdk/go/v0.3.1` and template tag `spin/templates/v0.3.1` will be created in `release` [action](https://github.com/fermyon/spin/actions/workflows/release.yaml).
1. When the `release`
